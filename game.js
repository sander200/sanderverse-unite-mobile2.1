...
(function () {
  ...
  const walkMask = {
    ...
    canEnt: function (x, y, r) {
      const s = Math.max(6, (r || 20) * 0.35);
      return this.can(x, y) && this.can(x - s, y) && this.can(x + s, y) && this.can(x, y - s) && this.can(x, y + s);
    }
  };
  ...
  function drawWorld() {
    ...
    if (!walkMask.ready) { const wm = assets.get("walk_mask"); if (wm) { walkMask.load(wm); rebuildWaypoints(); } }
